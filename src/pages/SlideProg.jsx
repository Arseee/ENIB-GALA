        ...
        <div className="flex justify-center flex-col">
          ...
          <div className="flex items-center justify-center text-center ">
            <ul className="pt-16 text-white  text-xl ">
              ...
              <li className="border-t-2 border-gray-400  w-60 mx-auto bottom-0 left-0 right-0 pt-8"></li>
              <li>Cocktail</li>
        ...
        <div className="flex justify-center flex-col">
          ...
          <div className="flex items-center justify-center text-center ">
            <ul className="pt-16 text-white  text-xl ">
              ...
              <li className="border-t-2 border-gray-400  w-60 mx-auto bottom-0 left-0 right-0 pt-10"></li>
              <li>Plat</li>
